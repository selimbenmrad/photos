...
class AppleOrangeSalad extends Component {
  ...
  const   ListeDataEN= [{
    ...
    Title: "Apple Orange Salad",
    Min: "5 min",
    Ingredients: "1- One orange (200g)\n2- One small apple (100g).\n3- One basil leaf\n4- One tbsp of rose water (optional).\n",
    ...
    const ListeDataAR= [{
      ...
      Title: "سلطة التفاح والبرتقال ",
      Min: " 5 دقائق",
      Ingredients: "1- (200غ) برتقالة.\n2-(100غ) تفاحة صغيرة.\n3-ورقة ريحان.\n4-ملعقة كبيرة من ماء الورد (اختياري).\n",
    ...
    const ListeDataFR= [{
      ...
      Title: "Salade de pomme et d'orange",
      Min: "5 min",
      Ingredients: "1-Une orange (200g).\n2-Une petite pomme (100g).\n3-Une feuille de besilic.\n4-Une cuillére à soupe d'eau de rose (optionel).\n",
...
export default connect(mapStateToProps, mapDispatchToProps)(AppleOrangeSalad);
